...
func (q *Queries) GetCommentsByPostID(ctx context.Context, postID int32) ([]CommentInfo, error) {
	rows, err := q.db.QueryContext(ctx, getCommentsByPostID, postID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []CommentInfo
	for rows.Next() {
		var column_1 CommentInfo
...
func (q *Queries) GetCommentsByUserID(ctx context.Context, userID int32) ([]CommentInfo, error) {
...
func (q *Queries) GetPostByID(ctx context.Context, id int32) (PostInfo, error) {
	row := q.db.QueryRowContext(ctx, getPostByID, id)
	var column_1 PostInfo
...
func (q *Queries) GetPosts(ctx context.Context, arg GetPostsParams) ([]PostInfo, error) {
...
func (q *Queries) GetPostsByCategory(ctx context.Context, arg GetPostsByCategoryParams) ([]PostInfo, error) {
...
func (q *Queries) GetPostsByUserID(ctx context.Context, userID int32) ([]PostInfo, error) {
